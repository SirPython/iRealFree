...
var _Metronome = require("./metronome/Metronome");
...
var _PatternSample = require("./sample/PatternSample");

var _PatternSample2 = _interopRequireDefault(_PatternSample);

var _PitchedSample = require("./sample/PitchedSample");

var _PitchedSample2 = _interopRequireDefault(_PitchedSample);
...
var samples = {
    piano: new _PitchedSample2.default("web/samples/piano.wav", _teoria2.default.note("c4"), ctx),
    bass: new _PitchedSample2.default("web/samples/ebass.wav", _teoria2.default.note("a2"), ctx),
    swing: new _PatternSample2.default("web/samples/swing.wav", 1, 120, ctx),
    swing_fill: new _PatternSample2.default("web/samples/swing.wav", 1, 120, ctx)
};

var form = document.forms[0];
form.submit.onclick = function () {
    var player = new _Player2.default(_Leadsheet2.default.parse(form.leadsheet.value), samples);
    player.play();
};

window.ctx = ctx;
window.samples = samples;
},{"./leadsheet/Leadsheet":2,"./leadsheet/Measure":3,"./leadsheet/Metadata":4,"./metronome/Metronome":5,"./player/Player":6,"./sample/PatternSample":7,"./sample/PitchedSample":8,"./sample/Sample":9,"teoria":19}],2:[function(require,module,exports){
"use strict";
    ...
    _createClass(Leadsheet, [{
        ...
        value: function parse(chart) {
            ...
            function (measure) {
                ...
                function (chord) {
                    return chord === "" ? null : _teoria2.default.chord(chord);
...
},{"./Measure":3,"./Metadata":4,"teoria":19}],3:[function(require,module,exports){
"use strict";
    ...
    _createClass(Metronome, [{
        ...
        value: function start(cb) {
            ...
            this.interval = setInterval(function () {
                cb({
                    beat: ++beat % _this.beats,
                    measure: Math.floor(beat / _this.beats)
                });
            }, this.bpms);
        }
...
var _Metronome = require("../metronome/Metronome.js");
 ...
 */
var Player = function () {
    function Player(leadsheet, samples) {
    ...
    _createClass(Player, [{
        key: "play",
        value: function play() {
            var _leadsheet = this.leadsheet;
            var metadata = _leadsheet.metadata;
            var measures = _leadsheet.measures;

            var samples = this.samples;
            var lastChord = measures[0].chords[0];

            var metronome = new _Metronome2.default(metadata.meter, metadata.bps);
            metronome.start(function (time) {
                console.log('tick');
                if (!measures[time.measure]) {
                    metronome.stop();
                    return;
                }
                var chord = measures[time.measure].getChord(time.beat);

                var octave = chord.root.octave() - samples.bass.note.octave() * 7 - 1;
                samples.bass.play(
                // TODO should start at beginning of chord on chord change (for two chords in measure, it starts on 5 and 7 of second chord)
                chord.notes()[time.beat].transpose(teoria.interval("P" + octave)), metadata.bps, ctx);

                /* If there was a chord change or a new mesaure started. */
                if (lastChord.name !== chord.name || time.beat === 0) {
                    samples.piano.play(chord.notes(), metadata.bps * metadata.meter, ctx);
                }

                if (time.beat === 0) {
                    // TODO doesn't support multi measure patterns
                    /* bpm * meter gets how long a whole note is. */
                    samples.swing.play(metadata.bps * metadata.meter, metadata.bps, ctx);
                }
        ...
        key: "playFrom",
        value: function playFrom(measure) {}
    }, {
        key: "stop",
        value: function stop() {}
    }]);
...
},{"../metronome/Metronome.js":5}],7:[function(require,module,exports){
"use strict";
 ...
 */
var PatternSample = function (_Sample) {
    _inherits(PatternSample, _Sample);
     ...
     */
    function PatternSample(href, length, bpm, ctx) {
        _classCallCheck(this, PatternSample);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PatternSample).call(this));

        _this.length = length;
        _this.bps = 60 / bpm; // this can be computed using the length of the sample and the measures it supposedly lasts.

        _this.audio = null; // _load will assign this
        _get(Object.getPrototypeOf(PatternSample.prototype), "_load", _this).call(_this, href, ctx);
        return _this;
    }
    ...
    _createClass(PatternSample, [{
        key: "play",
        value: function play(duration, bps, ctx) {
            var src = ctx.createBufferSource(); // TODO should this be refactored?
...
exports.default = PatternSample;
},{"./Sample":9}],8:[function(require,module,exports){
"use strict";
 ...
 */
var PitchedSample = function (_Sample) {
    _inherits(PitchedSample, _Sample);
     ...
     * @param {AudioContext} ctx The audio context.
     */
    function PitchedSample(href, note, ctx) {
        _classCallCheck(this, PitchedSample);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PitchedSample).call(this));

        _this.note = note;

        _this.audio = null; // _load will assign this
        _get(Object.getPrototypeOf(PitchedSample.prototype), "_load", _this).call(_this, href, ctx);
        return _this;
    }
    ...
    _createClass(PitchedSample, [{
        key: "play",
        value: function play(notes, duration, ctx) {
            var _this2 = this;
            ...
            notes.forEach(function (note) {
                ...
                src.buffer = _this2.audio;
                src.playbackRate.value = note.fq() / _this2.note.fq();
                src.connect(ctx.destination);
                src.start(0, 0, duration);
            });
        }
...
exports.default = PitchedSample;
},{"./Sample":9}],9:[function(require,module,exports){
"use strict";
...
},{"regenerator-runtime/runtime":17}],10:[function(require,module,exports){
...
},{"accidental-value":10,"notecoord":14}],13:[function(require,module,exports){
...
},{"accidental-value":10,"notecoord":14}],19:[function(require,module,exports){
...
},{"./lib/chord":20,"./lib/interval":21,"./lib/note":23,"./lib/scale":24,"./lib/sugar":25}],20:[function(require,module,exports){
...
},{"./interval":21,"./knowledge":22,"./note":23,"daccord":11}],21:[function(require,module,exports){
var knowledge = require('./knowledge');
...
},{"./knowledge":22,"./vector":26,"interval-coords":13}],22:[function(require,module,exports){
...
},{"./interval":21,"./knowledge":22,"./vector":26,"helmholtz":12,"pitch-fq":15,"scientific-notation":18}],24:[function(require,module,exports){
var knowledge = require('./knowledge');
var Interval = require('./interval');
...
},{"./interval":21,"./knowledge":22}],25:[function(require,module,exports){
var knowledge = require('./knowledge');
...
},{"./knowledge":22}],26:[function(require,module,exports){
module.exports = {
